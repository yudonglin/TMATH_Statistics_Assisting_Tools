...
def dotProduct(v1: MathVector, v2: MathVector) -> float:
    return v1.dot(v2)


def crossProduct(v1: MathVector, v2: MathVector) -> MathVector:
    return v1.cross(v2)
...
def workDoneBy(force: MathVector, distance: MathVector) -> float:
...
def vector_projection_of_u_onto_v(u: MathVector, v: MathVector) -> MathVector:
    return v * (dotProduct(u, v) / v.magnitude_sqr)


def scalar_projection_of_u_onto_v(u: MathVector, v: MathVector) -> float:
    return dotProduct(u, v) / v.magnitude
